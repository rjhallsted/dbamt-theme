...
/**
 * Print the html for the Mailchimp Signup form
 */
//Home test is for the tag on index.php. If it's not the homepage, it won't show.
function dbamt_mailchimp_signup( $run_home_test = false) {
	if( $run_home_test ) {
		if( is_home() )
			dbamt_mailchimp_signup_html();
	} else 
		dbamt_mailchimp_signup_html();
}

function dbamt_mailchimp_signup_html() { ?>
	<?php ob_start(); ?>
	<!-- Begin MailChimp Signup Form -->
	<div id="mc_embed_signup">
		<p class="form-copy">Want to get the posts in your inbox? Sign up below. No spam. Just honest words.</p>
		<form action="//dreambigandmakethings.us9.list-manage.com/subscribe/post?u=5b070c534faeb382a61223754&amp;id=3c77903bf1" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
		    <div id="mc_embed_signup_scroll">
			    ...
			    <div style="position: absolute; left: -5000px;"><input type="text" name="b_5b070c534faeb382a61223754_3c77903bf1" tabindex="-1" value=""></div>
			    <div class="clear">
