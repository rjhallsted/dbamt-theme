...
(function( $ ) {
	var baselineHeight = 16; //define your baseline height, in pixels, here.
...
//generally includes a .rythm-correct as well
jQuery( window ).ready( function($) {
	$( 'h1, h2, h3, h4, h5, h6, .gallery-item, img:not(.gallery-item img), #site_tagline, #site_title, form' ).correctRythm();
} );